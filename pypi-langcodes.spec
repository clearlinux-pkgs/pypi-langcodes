...
Source0  : https://files.pythonhosted.org/packages/57/a8/eef8555bb38e9a41451deabd7962b68764f1681bfd43a73e37a0586d8d04/langcodes-3.4.0.tar.gz
...
%prep
%setup -q -n langcodes-3.4.0
cd %{_builddir}/langcodes-3.4.0
pushd ..
cp -a langcodes-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713970657
...
cp %{_builddir}/langcodes-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-langcodes/d8e5cc4425b53480b6e68831c7774b85cd5a6b06 || :
