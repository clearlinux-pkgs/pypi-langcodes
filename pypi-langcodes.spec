...
Source0  : https://files.pythonhosted.org/packages/f4/79/adb488d97c8bad22fe69a1966c3fb47eb38b22598324d8ffbc5e88bc475d/langcodes-3.4.1.tar.gz
...
%prep
%setup -q -n langcodes-3.4.1
cd %{_builddir}/langcodes-3.4.1
pushd ..
cp -a langcodes-3.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727268770
